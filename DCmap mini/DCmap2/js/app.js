...
//////////////////////////////////F///////////////////////////////////////////////////////////   
 ...
 function DCmap0(){
	 ...
	 app.map.setView([Latitude0,Longitude0], 10);  // z : zoom out [-] 0--4---15--19[+] zoom in
    	
    	L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    	    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    	}).addTo(app.map);

    	L.marker([Latitude0,Longitude0],{icon: myGeo}).bindTooltip('[GC)'+Latitude0+','+Longitude0).addTo(app.map).openTooltip();
    	
    	dcInfo.innerHTML = '<br/>Latitude: x' + Latitude0 +'<br/>Longitude: y' + Longitude0+'<br/>Zoom: z'+app.map.getZoom();
...
function leafMap0() {
	...
	//alert('88'); //FT : Func Tracer
	 ...
	 var RandomListArray = RandomListArray0.split(",",2);
	    ...
	    // setView(x,y,z)  : x latitude , y longitude , z zoom
	 app.map.setView([RandomListArray[0],RandomListArray[1]], 7);   // z : zoom out [-] 0--4---15--19[+] zoom in
		 L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
		  attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
		 }).addTo(app.map);
		  
	//L.marker([x,y],{icon: myIcon}).addTo(map);
	L.marker([RandomListArray[0],RandomListArray[1]],{icon: myIcon}).bindTooltip(obj.LatLng[numbers].RandomListN).addTo(app.map).openTooltip();	
	
	dcInfo.innerHTML = '<br/>Latitude: x' + RandomListArray[0] +'<br/>Longitude: y' + RandomListArray[1]+'<br/>Zoom: z'+app.map.getZoom();
...
//////////////////////////////////I///////////////////////////////////////////////////////////
    ...
    function setDefaultEvents() {
        ...
        gpx_int__btn.addEventListener('click',DC.gpxInitBtn);
    }
    ...
    function init() {
        ...
        gpx_int__btn=document.getElementById('gpx-init-btn');
